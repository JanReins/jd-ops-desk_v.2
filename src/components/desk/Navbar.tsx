      ...
      <div className="mx-auto flex min-h-14 w-full min-w-0 max-w-7xl flex-wrap items-center justify-between gap-y-2 px-4 py-1 sm:px-6">
        ...
        <div className="flex items-center gap-2 text-xs sm:gap-3">
          ...
          <div className="relative">
            ...
            {showTools && (
              <div className="absolute right-0 z-50 mt-1.5 w-56 rounded-lg border border-line bg-raised py-1 shadow-panel">
                <button
                  type="button"
                ...
                {confirmReset ? (
                  <div className="flex items-center gap-1.5 px-3 py-2">
                    <span className="flex-1 text-2xs font-medium text-ink">Reset to workbook?</span>
                    <button
                      type="button"
                      disabled={resetting}
